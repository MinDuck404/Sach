package com.app.nhasach.database;
...
public class DBHelper extends SQLiteOpenHelper {
    ...
    private static final String db_Name = "Bansach.db"; // ✅ Đổi tên tại đây
    ...
    private void copyDatabaseIfNotExists() {
        ...
        if (!dbFile.exists()) {
            try {
                ...
                InputStream input = context.getAssets().open(db_Name); // ✅ đọc Bansach.db
    ...
    public void onCreate(SQLiteDatabase db) {
        // Không cần tạo bảng, vì đã có sẵn trong file Bansach.db
    }

    @Override
    public void onUpgrade(SQLiteDatabase db, int oldVersion, int newVersion) {
        // Nếu cần nâng cấp schema thì xử lý ở đây
    }
}
